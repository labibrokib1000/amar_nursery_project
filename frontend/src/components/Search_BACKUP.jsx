...
const StyledTextField = styled(TextField)(({ theme }) => ({
  '& .MuiOutlinedInput-root': {
    backgroundColor: 'rgba(232, 245, 233, 0.95)', // Light green background
    borderRadius: '25px',
    border: '2px solid #4CAF50', // Green border
    transition: 'all 0.3s ease',
    '&:hover': {
      backgroundColor: 'rgba(200, 230, 201, 0.95)', // Darker green on hover
      borderColor: '#388E3C',
      boxShadow: '0 4px 12px rgba(76, 175, 80, 0.2)', // Green shadow
    },
    '&.Mui-focused': {
      backgroundColor: 'rgba(200, 230, 201, 0.95)',
      borderColor: '#2E7D32', // Darker green when focused
      boxShadow: '0 6px 20px rgba(76, 175, 80, 0.3)', // Green shadow
    },
    '& fieldset': {
  ...
  '& .MuiOutlinedInput-input': {
    ...
    '&::placeholder': {
      color: '#4CAF50', // Green placeholder
      opacity: 0.8,
    },
  },
}));
...
const SearchResultsPaper = styled(Paper)(({ theme }) => ({
  maxHeight: '400px',
  overflow: 'auto',
  boxShadow: '0 8px 32px rgba(76, 175, 80, 0.2)', // Green shadow
  borderRadius: '12px',
  border: `2px solid #4CAF50`, // Green border
  backgroundColor: 'rgba(232, 245, 233, 0.98)', // Light green background
}));
...
const SearchItem = styled(ListItem)(({ theme }) => ({
  ...
  '&:hover': {
    backgroundColor: 'rgba(200, 230, 201, 0.6)', // Light green hover
    borderLeft: '4px solid #4CAF50', // Green left border on hover
    paddingLeft: '16px',
  },
  borderBottom: `1px solid rgba(76, 175, 80, 0.2)`, // Light green divider
  '&:last-child': {
    borderBottom: 'none',
  },
}));
